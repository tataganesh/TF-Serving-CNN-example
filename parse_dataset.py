...
IMAGES_FOLDER_PATH = 'dataset/_LABELLED_SAMPLES'
DATASET_METADATA_PATH = 'dataset/metadata.mat'
...
def create_dataset(mat, csv_writer):
    for sample in mat['video'][0]: 
        folder_name = sample[0][0]
        all_annotations = sample[6][0]
        base_path = os.path.join(IMAGES_FOLDER_PATH, folder_name)
...
mat = sio.loadmat(DATASET_METADATA_PATH)
